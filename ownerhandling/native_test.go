...
func TestNativeRevisionMetadata_RemoveFrom(t *testing.T) {
	...
	m := NewNativeRevisionMetadata(owner, testScheme, false)
	m.RemoveFrom(obj)
...
func TestNativeRevisionMetadata_SetCurrent(t *testing.T) {
	...
	m := NewNativeRevisionMetadata(cm1, testScheme, false)
	...
	m2 := NewNativeRevisionMetadata(cm2, testScheme, false)
...
func TestNativeRevisionMetadata_IsCurrent(t *testing.T) {
	...
	m1 := NewNativeRevisionMetadata(cm1, testScheme, false)
...
func TestNativeRevisionMetadata_GetCurrent(t *testing.T) {
	...
	for i := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			m := NewNativeRevisionMetadata(dummyOwner, testScheme, false)
			obj := &corev1.Secret{}
...
func TestNativeRevisionMetadata_IsNamespaceAllowed(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:                "same namespace, cross-namespace disabled",
			ownerNamespace:      "test",
			objNamespace:        "test",
		...
		{
			name:                "different namespace, cross-namespace disabled",
			ownerNamespace:      "test",
			objNamespace:        "other",
			allowCrossNamespace: false,
			expected:            false,
		...
		{
			name:                "different namespace, cross-namespace enabled",
			ownerNamespace:      "test",
			objNamespace:        "other",
		...
		{
			name:                "cluster-scoped owner, cross-namespace disabled",
		...
		{
			name:                "cluster-scoped owner, cross-namespace enabled",
			ownerNamespace:      "",
			objNamespace:        "any-namespace",
			allowCrossNamespace: true,
			expected:            true,
	...
	for i := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			m := NewNativeRevisionMetadata(owner, testScheme, tc.allowCrossNamespace)
...
func TestNativeRevisionMetadata_PanicsOnEmptyUID(t *testing.T) {
	...
	assert.Panics(t, func() {
		_ = NewNativeRevisionMetadata(owner, testScheme, false)
	})
}

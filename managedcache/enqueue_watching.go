...
func (e *EnqueueWatchingObjects) Create(
	_ context.Context, evt event.TypedCreateEvent[client.Object],
	q workqueue.TypedRateLimitingInterface[reconcile.Request]) {
	e.enqueueWatchers(evt.Object, q)
}

func (e *EnqueueWatchingObjects) Update(
	_ context.Context, evt event.TypedUpdateEvent[client.Object],
	q workqueue.TypedRateLimitingInterface[reconcile.Request],
) {
...
func (e *EnqueueWatchingObjects) enqueueWatchers(obj client.Object, q workqueue.TypedRateLimitingInterface[reconcile.Request]) {
	if obj == nil {
		return
	}
